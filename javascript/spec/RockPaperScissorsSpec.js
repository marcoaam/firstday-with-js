describe("Rock-Paper-Scissors", function() {
  ...
  describe('Winner announcement', function() {
    ...
    describe('standard message', function() {
      ...
      it('should return a message of the winner if the winner in player 1', function() {
          player1.picks('rock');
          player2.picks('paper');
      ...
      it('should return a message of the draw', function() {
          player1.picks('rock');
          player2.picks('rock');

          expect(game.announceWinner()).toEqual('It was a DRAW!!!');
